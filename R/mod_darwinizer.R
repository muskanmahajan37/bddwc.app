                 ...
                 div(
                   ...
                   column(1, div(
                     div(
                       ...
                       fluidRow(
                         actionButton(ns("darwinize"), "Darwinize", icon("award"), class = "activeButton shadow")
                       ),
                       hr(),
                       ...
                       fluidRow(actionButton(
                         ns("removeall"), "", icon("times-circle"), class = "readyButton shadow"
                       )),
                       hr(),
                       ...
                       fluidRow(
                         downloadButton(ns("downloadData"), "", class = "readyButton shadow downloadDataButton")
                       ),
                   ...
                   column(7, id = "fixed",
                          ...
                          column(3, div(
                            ...
                            div(class = "control-header stats-green", textOutput(ns(
                              "identitical_count"
                            ))),
...
mod_darwinizer_server <-
  function(input,
    ...
    darwin_dictionary_unique <-
      reactive(unique(darwin_dictionary()$standard))
    is_darwinized <- FALSE
    ...
    observeEvent(input$darwinize, {
      results <- bdDwC::darwinize_names(as.data.frame(data_original()),
      ...
      darwin_dictionary_unique <<-
        bdutilities::return_core(darwin_dictionary_unique)
      darwin_dictionary_unique <<-
        darwin_dictionary_unique[!(darwin_dictionary_unique %in% fixed_standards)]
